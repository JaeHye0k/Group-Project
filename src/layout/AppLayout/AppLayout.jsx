    ...
    <div className="component">
      <div className="navbar">
        ...
        <div className="menu-texts">
          <div className="menu-text" onClick={() => navigateTo('/')}>여행정보</div>
          <div className="menu-text" onClick={() => navigateTo('/map')}>여행지도</div>
        </div>
        ...
        <div className={`menu ${isMenuOpen ? 'open' : ''}`}>
          ...
          {isMenuOpen && (
            <div>
              ...
              <p className="mobile-menu-item" onClick={() => navigateTo('/')}>여행정보</p>
              <p className="mobile-menu-item" onClick={() => navigateTo('/map')}>여행지도</p>
              <Button>로그인</Button>
            </div>
          )}
